(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["vueMsalPlugin"] = factory(require("vue"));
	else
		root["vueMsalPlugin"] = factory(root["Vue"]);
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, "msalPluginInstance", function() { return /* reexport */ msalPluginInstance; });
__webpack_require__.d(__webpack_exports__, "MsalPlugin", function() { return /* reexport */ lib_MsalPlugin; });
...
// CONCATENATED MODULE: ./node_modules/@azure/msal-browser/dist/index.es.js
...
var index_es_name = "@azure/msal-common";
var version = "4.2.1";
...
var BaseClient = /** @class */ (function () {
    function BaseClient(configuration) {
        ...
        this.logger = new Logger(this.config.loggerOptions, index_es_name, version);
        // Initialize crypto
...
let msalInstance
let msalPluginInstance
class lib_MsalPlugin {
  constructor () {
    this.pluginOptions = {}
  ...
  install (vue, options) {
    ...
    vue.prototype.$msal = external_commonjs_vue_commonjs2_vue_root_Vue_default.a.observable(msalPluginInstance)
  }
...
//# sourceMappingURL=vueMsalPlugin.umd.js.map